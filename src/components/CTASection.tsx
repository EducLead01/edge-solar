    ...
    <section id="contato" className="py-20 lg:py-28 bg-gray-900">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="inline-flex items-center gap-2 bg-orange-500/20 text-orange-400 text-sm font-semibold px-4 py-2 rounded-full border border-orange-500/30 mb-8">
          ...
          10 dias de acesso gratuito
        </div>

        <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black text-white mb-6 leading-tight">
          Pronto para vender muito mais{" "}
          <span className="text-orange-400">com a SolarZ?</span>
        </h2>

        <p className="text-gray-400 text-lg mb-10 max-w-2xl mx-auto">
          Junte-se a mais de 6 mil integradores que já usam o ecossistema SolarZ
          para monitorar, vender e encantar clientes.
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <a
            href="https://wa.me/5511956751469"
        ...
        <p className="text-gray-600 text-sm mt-8">
          Sem compromisso. Fale com nosso Time Comercial.
        </p>
      </div>
    </section>
  );
